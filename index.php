...
function fremen_logo_showcase_register_block() {
    ...
    wp_register_script('slider-script', plugins_url('build/slider.js', __FILE__));
    wp_register_style('slider-style', plugins_url('build/tiny-slider.css', __FILE__));
    wp_register_style('slider-style-custom', plugins_url('build/custom.css', __FILE__));
